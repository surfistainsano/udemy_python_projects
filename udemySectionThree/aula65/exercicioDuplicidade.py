...
def encontraPrimeiroDuplicado(paramListaDeInteiros):
    numerosChecados = set()
    primeiroDuplicado = -1

    for numero in paramListaDeInteiros:
...
for listaDeInteiros in listaDeListasDeInteiros:
    print(listaDeInteiros, encontraPrimeiroDuplicado(listaDeInteiros))
